...
class CreateEmp extends Component {
    ...
    componentDidMount(){
        ...
        if(this.state.id === '_add'){
            ...
            EmpServices.getEmployeeById(this.state.id).then( (res) =>{
    ...
    saveOrUpdateEmployee = (e) => {
        ...
        // step 5
        if(this.state.id === '_add'){
            EmpServices.createEmployee(employee).then(res =>{
                this.props.history.push('/employees');
            });
        }else{
            EmpServices.updateEmployee(employee, this.state.id).then( res => {
                this.props.history.push('/employees');
            });
        }
    }
